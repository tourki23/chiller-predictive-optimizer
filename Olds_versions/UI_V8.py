...
def build_figures(df_plot, is_opti_active, target_date, x_range, ref_m1, ref_m2):
    ...
    # LÉGENDE RÉORGANISÉE : Affichage des marqueurs avec des noms clairs
    traces_temp = [
        go.Scatter(x=df_plot['timestamp'], y=df_plot['T_int'], mode='lines', name="🔵 T° Réelle", line=dict(color="#2485DB", width=2)),

...
def update_models_registry_ui(phys_name, ener_name):
    ...
    try:
        ...
        return dbc.Badge("Modèles chargés", color="success", className="w-100 p-2 mb-3"), time.time()
    except Exception as e:
        return dbc.Badge(f"Erreur: {str(e)}", color="danger", className="w-100 p-2 mb-3"), dash.no_update

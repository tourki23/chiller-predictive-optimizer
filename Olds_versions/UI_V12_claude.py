...
STYLE_PAGE = {
    "background": f"linear-gradient(135deg, {APP_BG} 0%, #111827 45%, #0B1020 100%)",
    "minHeight": "100vh",
...
def _make_common_layout(x_range, ui_rev, extra=None):
    layout = dict(
        ...
        plot_bgcolor="rgba(5,10,20,0.35)",
    ...
    dbc.Row([
        dbc.Col([
            html.Div([
                ...
                "padding": "22px 26px",
                "background": "linear-gradient(135deg, rgba(91,212,242,0.12), rgba(141,246,75,0.06))",
                "border": f"1px solid {BORDER_SOFT}",
                "borderRadius": "22px",
        ...
        metrics_table = dash_table.DataTable(
            ...
            style_data_conditional=[
                ...
                },
                {
                    ...
                    'backgroundColor': 'rgba(141, 246, 75, 0.15)'
                },
            ]
        )
